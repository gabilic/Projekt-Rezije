        ...
        <div id="container">
            ...
            <section>
                <div class="blok1">
                    ...
                    <p>Dobrodošli {if isset($smarty.session.prijava)} {$smarty.session.prijava.0} {/if}
                        na početnu stranicu sustava za pregled računa režija.
                        Za početak odaberite jednu od ponuđenih opcija u izborniku na lijevoj strani.</p>
                </div>
            </section>
        </div>
        <footer>
