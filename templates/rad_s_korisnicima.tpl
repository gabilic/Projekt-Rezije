...
<html>
    ...
    <body>
        ...
        <div id="container">
            ...
            <section>
                <div class="blok1">
                    <h2>Rad s korisnicima</h2>
                    <form>
                        <label>Otključavanje korisničkog računa: </label>
                        <select id="otkljucavanje">
                            <option value="-1">Korisnici</option>
                            <option value="0">===========</option>
                        </select>
                        <button type="button" id="otkljucaj">Otključaj</button><br><br>
                        <label>Blokiranje korisničkog računa: </label>
                        <select id="blokiranje">
                            <option value="-1">Korisnici</option>
                            <option value="0">===========</option>
                        </select>
                        <button type="button" id="blokiraj">Blokiraj</button>
                    </form><br>
                    <div id="poruka"></div>
                </div>
            </section>
        ...
        <script type="text/javascript" src="js/rad_s_korisnicima.js"></script>
    </body>
</html>