...
<html>
    ...
    <body>
        ...
        <div id="container">
            ...
            <section>
                <div class="blok1">
                    <h2>Aplikativna statistika</h2>
                    <form>
                        <label>Prikaz aplikativne statistike broja lajkova za: </label>
                        <button type="button" id="ustanove">Ustanove</button>
                        <button type="button" id="ocitavanje">Kategorije očitavanja</button><br><br>
                    </form><br>
                    <div id="poruka"></div>
                </div>
            </section>
        ...
        <script type="text/javascript" src="js/aplikativna_statistika.js"></script>
