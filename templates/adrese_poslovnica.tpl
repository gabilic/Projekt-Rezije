...
<html>
    ...
    <body>
        ...
        <div id="container">
            ...
            <section>
                <div class="blok1">
                    <h2>Definiranje adresa poslovnica</h2>
                    <form action="upload_adrese_poslovnica.php" method="post" enctype="multipart/form-data">
                        <label>Država: </label>
                        <input id="drzava"><br><br>
                        <label>Grad: </label>
                        <input id="grad"><br><br>
                        <label>Ulica: </label>
                        <input id="ulica"><br><br>
                        <label>Broj: </label>
                        <input id="broj"><br><br>
                        ...
                        <button type="button" id="spremi">Spremi promjene</button>
                        <button type="button" id="ispis">Ispiši adrese poslovnica</button><br><br>
                        <label>Unos preko CSV datoteke: </label>
                        <input type="file" name="datoteka" id="datoteka">
                        <input type="submit" value="Unesi podatke" name="csv" id="csv">
                    </form><br>
                    <div id="poruka"></div>
                </div>
            </section>
        ...
        <script type="text/javascript" src="js/adrese_poslovnica.js"></script>
    </body>
</html>