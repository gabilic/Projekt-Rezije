...
<html>
    ...
    <body>
        ...
        <div id="container">
            ...
            <section>
                <div class="blok1">
                    <h2>Kreiranje ustanova</h2>
                    <form action="upload_ustanove.php" method="post" enctype="multipart/form-data">
                        <label>Naziv ustanove: </label>
                        <input id="naziv"><br><br>
                        <label>Dodjela moderatora: </label>
                        <select id="korisnici">
                            <option value="-1">Korisnici</option>
                            <option value="0">===========</option>
                        </select><br><br>
                        <button type="button" id="spremi">Spremi promjene</button>
                        <button type="button" id="ispis">Ispiši ustanove i moderatore</button><br><br>
        ...
        <script type="text/javascript" src="js/ustanove.js"></script>
    </body>
</html>