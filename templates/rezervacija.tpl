...
<html>
    ...
    <body>
        ...
        <div id="container">
            ...
            <section>
                <div class="blok1">
                    <h2>Rezervacije očitavanja</h2>
                    <form>
                        <label>Rezervacija očitavanja: </label>
                        <select id="rezervacije">
                            <option value="-1">Rezervacije</option>
                            <option value="0">===========</option>
                        </select><br><br>
                        <button type="button" id="ispis">Ispiši podatke o rezervaciji</button>
                        <button type="button" id="potvrdi">Potvrdi rezervaciju</button>
                        <button type="button" id="odbij">Odbij rezervaciju</button><br><br>
                    </form><br>
                    <div id="poruka"></div>
                </div>
            </section>
        ...
        <script type="text/javascript" src="js/rezervacija.js"></script>
    </body>
</html>