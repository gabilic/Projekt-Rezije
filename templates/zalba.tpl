...
<html>
    ...
    <body>
            ...
            <section>
                <div class="blok1">
                    ...
                    <form>
                        <label>Žalba: </label>
                        <select id="zalbe">
                            <option value="-1">Žalbe</option>
                            <option value="0">===========</option>
                        </select><br><br>
                        <button type="button" id="ispis">Ispiši podatke o žalbi</button>
                        <button type="button" id="potvrdi">Ispostavi novi račun</button>
                        <button type="button" id="odbij">Odbij žalbu</button><br><br>
                    </form><br>
                    <div id="poruka"></div>
                </div>
            </section>
        ...
        <script type="text/javascript" src="js/zalba.js"></script>
    </body>
</html>