...
<html>
    ...
    <body>
        ...
        <div id="container">
            ...
            <section>
                <div class="blok1">
                    <h2>Podnošenje žalbe</h2>
                    <form action="podnesi_zalbu.php" method="post" enctype="multipart/form-data">
                        <label>Račun: </label>
                        <select id="racuni" name="racuni">
                            <option value="-1">Računi</option>
                            <option value="0">===========</option>
                        </select><br><br>
                        <label>Opis žalbe: </label>
                        <input id="opis" name="opis"><br><br>
                        <label>Slika stvarnog stanja: </label>
                        <input type="file" name="datoteka" id="datoteka"><br><br>
                        <label>Oznaka: </label>
                        <input id="oznaka" name="oznaka"><br><br>
                        <button type="button" id="ispis">Ispiši podatke o računu</button>
                        <input type="submit" value="Podnesi žalbu" name="potvrdi" id="potvrdi"><br><br>
                        <label>Prikaz galerije slika za: </label>
                        <select id="oznake">
                            <option value="-1">Oznaka</option>
                            <option value="0">===========</option>
                        </select>
                        <button type="button" id="galerija">Prikaži galeriju</button><br><br>
                    </form><br>
                    <div id="poruka"></div>
                </div>
            </section>
        ...
        <script type="text/javascript" src="js/korisnik_zalba.js"></script>
    </body>
</html>