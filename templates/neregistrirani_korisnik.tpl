...
<html>
    ...
    <body>
        ...
        <div id="container">
            ...
            <section>
                <div class="blok1">
                    <h2>Popis ustanova</h2>
                    <form>
                        <label>Popis ustanova: </label>
                        <select id="ustanove">
                            <option value="-1">Ustanove</option>
                            <option value="0">===========</option>
                        </select><br><br>
                        <button type="button" id="ispis">Prikaži 3 posljednje kategorije očitavanja</button>
                    </form><br>
                    <div id="poruka"></div>
                </div>
            </section>
        ...
        <script type="text/javascript" src="js/neregistrirani_korisnik.js"></script>
