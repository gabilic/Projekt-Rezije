...
<html>
    ...
    <body onload="kreirajDogadajPrijava();">
        <header>
            <h1>{$naslov}</h1>
            <p>Projekt režije</p>
        ...
        <div id="container">
            ...
            <section>
                <div class="blok1">
                    ...
                    <p>Molimo ispunite sljedeće podatke za prijavu:</p>
                    <div id="f2">
                        <form id="forma" method="post" name="forma" action="prijava.php">
                            <label for="korime" class="l mob2">Korisničko ime: </label>
                            <input type="text" id="korime" class="polje" name="korime" autofocus placeholder="korisničko ime" value={$kolacic}><br>
                            <label for="lozinka" class="l mob2">Lozinka: </label>
                            <input type="password" id="lozinka" class="polje" name="lozinka" placeholder="lozinka"><br>
                            <input type="checkbox" id="zapamti" class="polje" name="zapamti" checked>
                            <label for="zapamti" class="l">Zapamti me</label><br><span class="razmak">&nbsp;</span>
                            <input type="submit" value="Prijavi se"><br>
                            <a href="javascript:zaboravljenaLozinka();">Zaboravili ste lozinku?</a><br>
