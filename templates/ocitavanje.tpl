...
<html>
    ...
    <body>
        ...
        <div id="container">
            ...
            <section>
                <div class="blok1">
                    <h2>Kategorije i cijena usluge očitavanja</h2>
                    <form>
                        <label>Kategorija očitavanja: </label>
                        <input id="kategorija"><br><br>
                        <label>Cijena usluge očitavanja: </label>
                        <input id="cijena"><br><br>
                        ...
                        <button type="button" id="ispis">Ispiši kategorije i cijene usluge očitavanja</button><br><br>
                    </form><br>
                    <div id="poruka"></div>
                </div>
            </section>
        ...
        <script type="text/javascript" src="js/ocitavanje.js"></script>
    </body>
</html>