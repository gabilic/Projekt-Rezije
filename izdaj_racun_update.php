...
$zalba = $_GET["zalba"];
$id_zalbe = preg_replace("/[^0-9]/", "", $zalba);
...
$rs->close();
$sql2 = "UPDATE racun SET datum_vrijeme = '" . $datum_vrijeme .
        "', naziv_usluge = '" . $usluga . "', cijena_usluge = " .
        $cijena . ", ocitano_stanje = " . $stanje . ", potrosnja = " .
        $potrosnja . ", ime_djelatnika = '" . $djelatnik .
        "', ime_korisnika = '" . $korisnik . "', rezervacija_id = " . $id .
        " WHERE id = " . $id_zalbe;
$bp->updateDB($sql2);
if ($bp->pogreskaDB()) {
    $status = "neuspjeh";
