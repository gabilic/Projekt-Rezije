...
$bp = new Baza();
if($lajk === "Sviđa mi se") {
    $sql1 = "INSERT INTO lajkovi_ustanova VALUES ('" . $_SESSION["prijava"][0] .
            "', (SELECT id FROM ustanova WHERE naziv = '" . $ustanova . "'))";
    $sql2 = "UPDATE ustanova SET broj_lajkova = broj_lajkova + 1 WHERE naziv = '" .
            $ustanova . "'";
}
else {
    $sql1 = "DELETE FROM lajkovi_ustanova WHERE korisnici_korisnicko_ime = '" .
            $_SESSION["prijava"][0] . "' AND ustanova_id = " .
            "(SELECT id FROM ustanova WHERE naziv = '" . $ustanova . "')";
    $sql2 = "UPDATE ustanova SET broj_lajkova = broj_lajkova - 1 WHERE naziv = '" .
            $ustanova . "'";
}
